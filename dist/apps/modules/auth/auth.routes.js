...
router.post(
  ...
  (0, validateRequest_1.validateRequest)(
    auth_validataion_1.AuthValidation.authZodSchema
  ),
...
router.post(
  '/refresh-token',
  (0, validateRequest_1.validateRequest)(
    auth_validataion_1.AuthValidation.refreshtokenZodSchema
  ),
...
router.patch(
  '/change-password',
  (0, validateRequest_1.validateRequest)(
    auth_validataion_1.AuthValidation.changePasswordZodSchema
  ),
  (0, authValidtaionRoute_1.atuthValidationRoute)(
