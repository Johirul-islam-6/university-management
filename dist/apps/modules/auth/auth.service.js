...
const loingUser = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ...
      !(yield users_model_1.User === null || users_model_1.User === void 0
        ? void 0
        : users_model_1.User.isPasswordMatch(password, isUserExist.password))
    ) {
      throw new ApiError_1.ApiError(
...
const changePassword = (user, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // alternative way
    const isUserExist = yield users_model_1.User.findOne({
    ...
    if (
      ...
      !(yield users_model_1.User === null || users_model_1.User === void 0
        ? void 0
        : users_model_1.User.isPasswordMatch(oldPassword, isUserExist.password))
    ) {
      throw new ApiError_1.ApiError(
        http_status_1.default.UNAUTHORIZED,
