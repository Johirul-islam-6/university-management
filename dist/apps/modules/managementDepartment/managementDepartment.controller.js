...
const getAllDepartments = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, quaryPick_1.queryPick)(req.query, managementDepartment_constant_1.managementDepartmentFilterableFields);
    const paginationOptions = (0, quaryPick_1.queryPick)(req.query, pagination_1.pagintionField);
...
const updateDepartment = (0, catchAsync_1.catchAsync)((0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
