...
const createStudent = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield users_service_1.UserServices.createdStuden(student, userData);
...
// create a faculty
const createFaculy = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _b = req.body, { faculty } = _b, userData = __rest(_b, ["faculty"]);
    const result = yield users_service_1.UserServices.createFaculty(faculty, userData);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const createAdmin = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield users_service_1.UserServices.createAdmin(admin, userData);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
