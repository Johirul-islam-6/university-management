...
router.patch(
  ...
  (0, validateRequest_1.validateRequest)(
    zodAcademicSemester_validation_1.AcademicSemesterValidation
...
router.get(
  '/:id',
  academicSemester_controller_1.AcademicSemesterController.getSingelSemester
);
router.delete(
  '/:id',
  academicSemester_controller_1.AcademicSemesterController.DeleteSingelSemester
);
