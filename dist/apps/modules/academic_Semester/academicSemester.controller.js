...
const CreateAcademicSemester = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const academicSemester = __rest(req.body, []);
    // console.log("first", academicSemester)
    const result =
      yield academicSemester_service_1.AcademicSemesterServices.createAcademicSemester(
        academicSemester
      );
...
const getAllSemester = (0, catchAsync_1.catchAsync)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_service_1.AcademicSemesterServices.getAllSemesterServe(
        filtering,
        paginationOption
      );
    // create a senrespons function
...
//get singel semester
const getSingelSemester = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const semester = req.params.id;
    const result =
      yield academicSemester_service_1.AcademicSemesterServices.singelSemester(
        semester
      );
    (0, sendResponse_1.sendResponse)(res, {
      statusCode: http_status_1.default.OK,
...
const updateSemester = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicSemester_service_1.AcademicSemesterServices.updateSemester(
        semesterid,
        updateData
      );
    (0, sendResponse_1.sendResponse)(res, {
...
const DeleteSingelSemester = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result =
      yield academicSemester_service_1.AcademicSemesterServices.DeleteSemester(
        id
      );
    (0, sendResponse_1.sendResponse)(res, {
      statusCode: http_status_1.default.OK,
