...
academicSemesterModel.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isExist) {
            throw new ApiError_1.ApiError(http_status_1.default.CONFLICT, 'Academic Semester already Exist !', '');
        }
        next();
    });
});
// 3. Create a Model.
exports.AcademicSemester = (0, mongoose_2.model)('AcademicSemester', academicSemesterModel);
