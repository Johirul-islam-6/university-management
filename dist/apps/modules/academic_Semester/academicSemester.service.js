...
const createAcademicSemester = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      academic_constant_1.AcademicSemesterTitleCodeMapping[payload.title] !==
      payload.code
    ) {
...
const getAllSemesterServe = (filtering, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm } = filtering,
      filtersData = __rest(filtering, ['searchTerm']);
    const andConditions = [];
    // serchdata resive
    if (searchTerm) {
      andConditions.push({
        $or: academic_constant_1.academicSemesterSearchableFields.map(
          field => ({
            [field]: {
              $regex: searchTerm,
              $options: 'i',
...
//singel a semester
const singelSemester = semesterId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicSemester_model_1.AcademicSemester.findOne({
      _id: semesterId,
    });
    return result;
  });
// update semester
const updateSemester = (semesterId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
