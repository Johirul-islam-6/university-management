...
router.patch('/:id', (0, validateRequest_1.validateRequest)(faculty_validations_1.FacultyValidation.updateFacultyZodSchema), faculty_controller_1.FacultyController.updateFaculty);
